...
studyAreaLocation <- file.path(Paths$inputPath, "studyArea") #give the location of the studyArea shapefile
.studyAreaName <- "EeyouIstchee.shp" #specify the file name of the studyArea shapefile
...
nameBCR <- "12" #give the name of the BCR you want to create rasters for in the format: "##"
