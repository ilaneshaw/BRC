...
print("get parameters from local")
...
#rasterToMatchLocation <- inputsDir #personal laptop
rasterToMatchLocation <- inputsDir
rasterToMatchName <- "LCC2005_V1_4a.tif"
#studyAreaLocation <- downloadFolderArea #personal laptop
studyAreaLocation <- downloadFolderArea
nameBCR <- "12"
bootRastersLocation <- inputBootBirdRasters
#bootRastersLocation <- inputBootBirdRasters #personal laptop
.studyAreaName <- "EeyouIstchee.shp" #specify file name
