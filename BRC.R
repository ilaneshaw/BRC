...
defineModule(sim, list(
  ...
  reqdPkgs = list("SpaDES.core", "data.table", "LandR", "googledrive", "plotrix", "ggpubr", "diptest", "nortest", "dplyr", "ggplot2", "tidyverse", "terra", "reshape2", "RColorBrewer", "rasterVis"),
  parameters = bindrows(
    ...
    defineParameter(
      "archiveStudyArea", "character", NA, NA, NA,
